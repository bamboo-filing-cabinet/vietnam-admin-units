...
Phase-3 build uses a reviewed 204-date crawl with deterministic gzip storage; **80 dates are verified
and 124 remain** after the host recovered and four event batches completed. See [Emergency ward-source
