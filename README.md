...
Phase-3 build uses a reviewed 204-date crawl with deterministic gzip storage; **40 dates are verified
and 164 remain** after the host recovered and two event batches completed. See [Emergency ward-source
