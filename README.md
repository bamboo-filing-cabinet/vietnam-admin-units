...
Phase-3 build uses a reviewed 204-date crawl with deterministic gzip storage; **60 dates are verified
and 144 remain** after the host recovered and three event batches completed. See [Emergency ward-source
