...
Phase-3 build uses a reviewed 204-date crawl with deterministic gzip storage; **20 dates are verified
and 184 remain** after the host recovered and the first event batch completed. See [Emergency ward-source
