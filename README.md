...
Phase-3 build uses a reviewed 204-date crawl with deterministic gzip storage; **100 dates are verified
and 104 remain** after the host recovered and five event batches completed. See [Emergency ward-source
