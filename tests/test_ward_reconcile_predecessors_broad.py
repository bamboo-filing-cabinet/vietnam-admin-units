...
def test_committed_broad_artifact_and_query_are_reproducible():
    ...
    assert artifact["audit"] == {
        "api_verified_candidates": 82,
        "auto_matched_rows": 60,
        "candidate_items": 10514,
        "classification_counts": {
            "ambiguous-verified-candidates": 2,
            "assigned-item-only": 847,
            "no-broad-candidate": 189,
            "no-broad-district-candidate": 2520,
            "qid-collision-preferred-exact-tier-other-row": 10,
            "verification-rejected": 20,
            "verified-unique": 60,
        },
        "query_result_rows": 15977,
        "query_terms": 11116,
        "rows_with_any_candidate": 2612,
        "rows_with_district_candidate": 92,
        "rows_with_verified_candidate": 72,
        "shortlisted_qids": 82,
        "unresolved_predecessor_rows": 3648,
        "unresolved_rows": 3588,
    }
