...
def test_committed_broad_artifact_and_query_are_reproducible():
    ...
    assert artifact["audit"] == {
        ...
        "candidate_items": 10513,
        "classification_counts": {
            "ambiguous-verified-candidates": 2,
            "assigned-item-only": 847,
            "no-broad-candidate": 189,
            "no-broad-district-candidate": 2518,
            "qid-collision-preferred-exact-tier-other-row": 10,
            "verification-rejected": 21,
            "verified-unique": 60,
        },
        "query_result_rows": 15975,
        "query_terms": 11115,
        "rows_with_any_candidate": 2611,
        "rows_with_district_candidate": 93,
        "rows_with_verified_candidate": 72,
        "shortlisted_qids": 82,
        "unresolved_predecessor_rows": 3647,
        "unresolved_rows": 3587,
    }
