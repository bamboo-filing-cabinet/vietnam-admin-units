...
def test_committed_broad_artifact_and_query_are_reproducible():
    ...
    assert artifact["audit"] == {
        "api_verified_candidates": 78,
        "auto_matched_rows": 56,
        "candidate_items": 10657,
        "classification_counts": {
            "ambiguous-verified-candidates": 2,
            "assigned-item-only": 843,
            "no-broad-candidate": 191,
            "no-broad-district-candidate": 2623,
            "verification-rejected": 11,
            "verified-unique": 56,
        },
        "query_result_rows": 16240,
        "query_terms": 11317,
        "rows_with_any_candidate": 2692,
        "rows_with_district_candidate": 69,
        "rows_with_verified_candidate": 58,
        "shortlisted_qids": 78,
        "unresolved_predecessor_rows": 3726,
        "unresolved_rows": 3670,
    }
