...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4666,
        "rows_with_name_candidate": 8561,
        "rows_with_district_candidate": 6489,
        "shortlisted_qids": 6480,
        "api_verified_candidates": 6480,
        "rows_with_verified_candidate": 6487,
        "auto_matched_rows": 6402,
        "unresolved_rows": 3633,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1231,
            "no-district-candidate": 2072,
