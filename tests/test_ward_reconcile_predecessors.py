...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_district_candidate": 6506,
        "shortlisted_qids": 6497,
        "api_verified_candidates": 6497,
        "rows_with_verified_candidate": 6504,
        "auto_matched_rows": 6419,
        "unresolved_rows": 3616,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1222,
            "no-district-candidate": 2064,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6419,
        },
    }
