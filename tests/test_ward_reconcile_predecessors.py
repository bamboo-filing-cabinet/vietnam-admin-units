...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_district_candidate": 6480,
        "shortlisted_qids": 6471,
        "api_verified_candidates": 6471,
        "rows_with_verified_candidate": 6478,
        "auto_matched_rows": 6395,
        "unresolved_rows": 3640,
        "classification_counts": {
            "ambiguous-verified-candidates": 35,
            "current-item-repurposed": 1232,
            "no-district-candidate": 2080,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6395,
        },
    }
