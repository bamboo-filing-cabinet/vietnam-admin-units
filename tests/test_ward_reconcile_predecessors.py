...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4669,
        "rows_with_name_candidate": 8561,
        "rows_with_district_candidate": 6487,
        "shortlisted_qids": 6477,
        "api_verified_candidates": 6477,
        "rows_with_verified_candidate": 6485,
        "auto_matched_rows": 6400,
        "unresolved_rows": 3635,
        "classification_counts": {
            "ambiguous-verified-candidates": 35,
            "current-item-repurposed": 1231,
            "no-district-candidate": 2074,
            "no-name-candidate": 243,
            "qid-collision": 50,
            "verification-rejected": 2,
            "verified-unique": 6400,
        },
    }
