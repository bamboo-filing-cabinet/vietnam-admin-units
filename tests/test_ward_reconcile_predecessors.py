...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4658,
        "rows_with_name_candidate": 8564,
        "rows_with_district_candidate": 6499,
        "shortlisted_qids": 6490,
        "api_verified_candidates": 6490,
        "rows_with_verified_candidate": 6497,
        "auto_matched_rows": 6412,
        "unresolved_rows": 3623,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1228,
            "no-district-candidate": 2065,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6412,
        },
    }
