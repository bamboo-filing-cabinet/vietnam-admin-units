...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_district_candidate": 6523,
        "shortlisted_qids": 6513,
        "api_verified_candidates": 6513,
        "rows_with_verified_candidate": 6521,
        "auto_matched_rows": 6436,
        "unresolved_rows": 3599,
