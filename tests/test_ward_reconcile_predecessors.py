...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4644,
        "rows_with_name_candidate": 8571,
        "rows_with_district_candidate": 6513,
        "shortlisted_qids": 6504,
        "api_verified_candidates": 6504,
        "rows_with_verified_candidate": 6511,
        "auto_matched_rows": 6426,
        "unresolved_rows": 3609,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1221,
            "no-district-candidate": 2058,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6426,
        },
    }
