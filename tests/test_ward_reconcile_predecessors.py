...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4673,
        "rows_with_name_candidate": 8560,
        "rows_with_district_candidate": 6483,
        "shortlisted_qids": 6473,
        "api_verified_candidates": 6473,
        "rows_with_verified_candidate": 6481,
        "auto_matched_rows": 6396,
        "unresolved_rows": 3639,
        "classification_counts": {
            "ambiguous-verified-candidates": 35,
            "current-item-repurposed": 1232,
            "no-district-candidate": 2077,
            "no-name-candidate": 243,
            "qid-collision": 50,
            "verification-rejected": 2,
            "verified-unique": 6396,
        },
    }
