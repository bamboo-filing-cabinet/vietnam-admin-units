...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4655,
        "rows_with_name_candidate": 8567,
        "rows_with_district_candidate": 6503,
        "shortlisted_qids": 6494,
        "api_verified_candidates": 6494,
        "rows_with_verified_candidate": 6501,
        "auto_matched_rows": 6416,
        "unresolved_rows": 3619,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1225,
            "no-district-candidate": 2064,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6416,
        },
    }
