...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4661,
        "rows_with_name_candidate": 8563,
        "rows_with_district_candidate": 6496,
        "shortlisted_qids": 6487,
        "api_verified_candidates": 6487,
        "rows_with_verified_candidate": 6494,
        "auto_matched_rows": 6409,
        "unresolved_rows": 3626,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1229,
            "no-district-candidate": 2067,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6409,
        },
    }
