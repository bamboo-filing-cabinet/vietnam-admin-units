...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4668,
        "rows_with_name_candidate": 8562,
        "rows_with_district_candidate": 6489,
        "shortlisted_qids": 6479,
        "api_verified_candidates": 6479,
        "rows_with_verified_candidate": 6487,
        "auto_matched_rows": 6402,
        "unresolved_rows": 3633,
        "classification_counts": {
            "ambiguous-verified-candidates": 35,
            "current-item-repurposed": 1230,
            "no-district-candidate": 2073,
            "no-name-candidate": 243,
            "qid-collision": 50,
            "verification-rejected": 2,
            "verified-unique": 6402,
        },
    }
