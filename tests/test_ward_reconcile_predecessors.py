...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_name_candidate": 8574,
        "rows_with_district_candidate": 6520,
        "shortlisted_qids": 6511,
        "api_verified_candidates": 6511,
        "rows_with_verified_candidate": 6518,
        "auto_matched_rows": 6433,
        "unresolved_rows": 3602,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1218,
            "no-district-candidate": 2054,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6433,
        },
    }
