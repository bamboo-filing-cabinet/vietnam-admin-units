...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_district_candidate": 6472,
        "shortlisted_qids": 6463,
        "api_verified_candidates": 6463,
        "rows_with_verified_candidate": 6470,
        "auto_matched_rows": 6387,
        "unresolved_rows": 3648,
        "classification_counts": {
            "ambiguous-verified-candidates": 35,
            "current-item-repurposed": 1233,
            "no-district-candidate": 2087,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6387,
        },
    }
