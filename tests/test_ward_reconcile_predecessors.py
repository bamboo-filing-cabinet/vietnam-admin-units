...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_district_candidate": 6494,
        "shortlisted_qids": 6485,
        "api_verified_candidates": 6485,
        "rows_with_verified_candidate": 6492,
        "auto_matched_rows": 6407,
        "unresolved_rows": 3628,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1229,
            "no-district-candidate": 2069,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6407,
        },
    }
