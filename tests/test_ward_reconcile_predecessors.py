...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "current_assigned_qids": 3320,
        "rows_with_current_qid_excluded": 4642,
        "rows_with_name_candidate": 8576,
        "rows_with_district_candidate": 6522,
        "shortlisted_qids": 6512,
        "api_verified_candidates": 6512,
        "rows_with_verified_candidate": 6520,
        "auto_matched_rows": 6435,
        "unresolved_rows": 3600,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1216,
            "no-district-candidate": 2054,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6435,
        },
    }
