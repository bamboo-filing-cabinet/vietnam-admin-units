...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4665,
        "rows_with_name_candidate": 8562,
        "rows_with_district_candidate": 6492,
        "shortlisted_qids": 6483,
        "api_verified_candidates": 6483,
        "rows_with_verified_candidate": 6490,
        "auto_matched_rows": 6405,
        "unresolved_rows": 3630,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1230,
            "no-district-candidate": 2070,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6405,
        },
    }
