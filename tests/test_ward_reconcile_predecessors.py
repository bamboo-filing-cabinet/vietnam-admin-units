...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4654,
        "rows_with_name_candidate": 8570,
        "rows_with_district_candidate": 6509,
        "shortlisted_qids": 6500,
        "api_verified_candidates": 6500,
        "rows_with_verified_candidate": 6507,
        "auto_matched_rows": 6422,
        "unresolved_rows": 3613,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1222,
            "no-district-candidate": 2061,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6422,
        },
    }
