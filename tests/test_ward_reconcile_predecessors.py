...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4674,
        "rows_with_name_candidate": 8559,
        "rows_with_district_candidate": 6473,
        "shortlisted_qids": 6464,
        "api_verified_candidates": 6464,
        "rows_with_verified_candidate": 6471,
        "auto_matched_rows": 6388,
        "unresolved_rows": 3647,
        "classification_counts": {
            "ambiguous-verified-candidates": 35,
            "current-item-repurposed": 1233,
            "no-district-candidate": 2086,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6388,
        },
    }
