...
def test_committed_predecessor_artifact_is_complete_and_collision_free():
    ...
    assert artifact["audit"] == {
        ...
        "rows_with_current_qid_excluded": 4641,
        "rows_with_name_candidate": 8577,
        "rows_with_district_candidate": 6524,
        "shortlisted_qids": 6514,
        "api_verified_candidates": 6514,
        "rows_with_verified_candidate": 6522,
        "auto_matched_rows": 6437,
        "unresolved_rows": 3598,
        "classification_counts": {
            "ambiguous-verified-candidates": 37,
            "current-item-repurposed": 1215,
            "no-district-candidate": 2053,
            "no-name-candidate": 243,
            "qid-collision": 48,
            "verification-rejected": 2,
            "verified-unique": 6437,
        },
    }
