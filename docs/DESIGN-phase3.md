...
> 10,586-edge 2025 composition. Saved read-only Wikidata evidence now maps
> 2,670 of 3,321 current wards and leaves 651 explicitly queued for review; emission
> remains unstarted and separately gated. See
> `docs/journals/2026-09-01.03.ward-history-graph.md` and
> `docs/journals/2026-09-01.05.ward-wikidata-reconciliation.md` plus
> `docs/journals/2026-09-01.06.ward-wikidata-review-reduction.md`.
