...
- **Ward SOAP raw-cache recovery (2026-08-27/28): critical slice DONE; history
  180/204.** The initial audit found no real `DanhMucPhuongXa` response in the
  ...
  failed again. After recovery, nine event batches completed through
  2019-12-01. The 204-date inventory is pinned with `--plan-as-of 2026-08-27`;
  resume at 2020-01-01 (entry 181), with 24 dates remaining. The former
