...
- **Phase 3 (wards)** — ward tier (10k→3.3k in 2025 reform), name→code
  ...
  and two manually. The other 3,879 were provisional former-item creation gaps.
  Five fixed-seed random samples of ten found 14 existing items, exposing a 28%
  miss rate in the terminal-parent-only gate. The applied sample corrections
  leave 3,865 provisional gaps, and the consolidated draft now fails closed.
  The 2025 lineage remains hard-blocked while broader reconciliation is
  repaired; see
...
- ~~**2025 ward boundary + composition topology**~~ **DONE (2026-08-28).** The
  ...
  edges with zero unresolved predecessors (`2026-08-28.01`–`.02`). Historical
  ...
  **OPEN** at 418/449 official, 29 primary-source-open instruments, and 29
  change-bearing-open instruments; the registry preserves 411 official
  attachments and 829 official artifacts. No secondary page is promoted to
